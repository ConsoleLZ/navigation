...
<template>
  <div class="app">
    <Navbar></Navbar>
    <div class="main">
      <div class="card bg-base-100 shadow-xl" v-for="item in data" :key="item.id">
        <figure>
        ...
        <div class="card-body">
          ...
          <p>
            <span v-for="tagsItem in item.tags" style="margin-right: 5px;" class="badge badge-outline">{{ tagsItem }}</span>
          </p>
